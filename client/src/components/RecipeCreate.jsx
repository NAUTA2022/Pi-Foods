    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <form onSubmit={(e) => {handleSubmit(e)}} className={styles.form}>
                ...
                {errors.hasOwnProperty('title') || errors.hasOwnProperty('summary') || errors.hasOwnProperty('spoonacularScore') || errors.hasOwnProperty('healthScore')?  <p className={styles.adv}> please complete all the inputs to create your recipe</p> : <button type='submit' className={styles.correct}> Crear Receta</button>  }
